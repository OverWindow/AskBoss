...
import { Archive, ChevronDown, ChevronUp, MessageCircle, X } from "lucide-react";
...
function ArchiveCard({ summary }: { summary: TranslationArchiveSummary }) {
