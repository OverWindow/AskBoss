import type { BossPersona, BossScope } from "../shared.js";
...
export const personalBossSystemPrompt = (basePrompt?: string, globalPersona?: BossPersona | null) => `${evidenceBoundary}
...
export const bossSystemPrompt = (scope: BossScope, basePrompt?: string, globalPersona?: BossPersona | null) => scope === "GLOBAL"
