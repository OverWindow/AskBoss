import type { AdminOperation, Boss, BossPersona, CompanyResearch, GlobalBossDefaults, PersonalBossDefaults, PkiBreakdown, TranslationResult, UserProfile } from "./shared.js";
...
export type { GlobalBossDefaults, PersonalBossDefaults };
