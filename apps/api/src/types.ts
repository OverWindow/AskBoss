import type { AdminOperation, Boss, BossPersona, CompanyResearch, GlobalBossDefaults, PersonalBossDefaults, PkiBreakdown, TranslationExamplesSettings, TranslationResult, UserProfile } from "./shared.js";
