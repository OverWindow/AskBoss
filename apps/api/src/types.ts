import type { AdminOperation, Boss, BossPersona, CompanyResearch, PersonalBossDefaults, PkiBreakdown, TranslationResult, UserProfile } from "./shared.js";
...
export type { PersonalBossDefaults };
