...
import { DEFAULT_TRANSLATION_REPLY_STYLES, OBSERVATION_CATEGORIES } from "../../shared.js";
...
export class FakeAiService implements AiService {
  ...
  async translateBossMessage(input:any): Promise<TranslationResult> { const styles = input.replyStyles ?? DEFAULT_TRANSLATION_REPLY_STYLES; return {plainMeaning:"완성을 기다리기보다 현재 진행 상황과 남은 일정을 먼저 공유해 달라는 뜻에 가깝습니다.",likelyIntent:["진행 상황 확인","일정 지연 여부 확인","추가 지시 필요 여부 판단"],tone:"확인을 재촉하는 실무적 표현",caution:"표현만으로 실제 의도를 단정할 수는 없습니다.",confidence:0.72,surfaceActualGapScore:35,replies:[{text:"네, 현재까지 진행된 내용과 남은 일정을 정리해서 먼저 공유드리겠습니다.",style:styles[0],reason:"상태와 다음 행동을 함께 전달합니다."},{text:"현재 약 70% 진행됐고, 오늘 오후 중 공유드리겠습니다.",style:styles[1],reason:"진행률과 시점을 바로 답합니다."},{text:"네 팀장님. 진행 상황과 남은 작업을 함께 정리해 먼저 공유드리겠습니다.",style:styles[2],reason:"확인 의도를 존중하면서 부담 없이 답합니다."}]}; }
